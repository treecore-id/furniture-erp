...
<html lang="en">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0" role="main">
            <div class="flex w-full justify-center items-center max-w-xl mx-auto p-10">
                <div class="flex min-w-0 flex-1 flex-col items-center justify-center gap-6 text-balance rounded-lg border-dashed p-6 text-center md:p-12">
                    ...
                    <div class="flex w-full min-w-0 max-w-sm flex-col items-center gap-4 text-balance text-sm">
                        <p class="text-muted-foreground text-sm/relaxed">
                            @yield('title')
                        </p>
                    </div>
