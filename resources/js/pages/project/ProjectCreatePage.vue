    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <div class="flex flex-col px-4 py-6 space-y-6">
            ...
            <form @submit.prevent="submit" autocomplete="off">
                <div class="space-y-4 px-1 overflow-hidden">
                    <div class="flex flex-wrap space-y-6 mb-4 -mx-3 sticky top-0">
                        <div class="w-full px-3 lg:w-1/4 space-y-2">
                            ...
                            <InputError :message="new_project.errors.name" />
                        </div>
                        <div class="w-full px-3 lg:w-1/4 space-y-2">
                            <Label for="client">Client</Label>
                            <Input id="client" name="client" type="text" class="mt-1 block w-full" placeholder="Client" />
                            <InputError :message="new_project.errors.client" />
                        </div>
                        <div class="w-full px-3 lg:w-1/4 space-y-2">
                            ...
                            <InputError :message="new_project.errors.project_value" />
                        </div>
                        <div class="w-full px-3 lg:w-1/4 space-y-2">
                            <Label for="date_start">Date Start</Label>
                            <Input id="date_start" name="date_start" type="text" class="mt-1 block w-full" placeholder="Value" />
                            <InputError :message="new_project.errors.date_start" />
                        </div>
                        <div class="w-full px-3 lg:w-1/4 space-y-2">
